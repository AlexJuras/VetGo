<template>
    <Head :title="`Editar Tutor | ${$page.component}`" />
            ...
            <div class="card-pastel">
                ...
                <div class="text-center mt-8 space-y-2">
                    <p class="text-gray-600">
                        Quer cadastrar um novo animal para este tutor?
                        <a
                            :href="`/animals/create?tutor_id=${tutor.id}`"
...
export default {
    ...
    setup(props) {
        const form = useForm({
            nome: props.tutor.nome || "",
            cpf: props.tutor.cpf || "",
            telefone: props.tutor.telefone || "",
            data_nascimento: props.tutor.data_nascimento || "",
            email: props.tutor.email || "",
            genero: props.tutor.genero || "",
            cidade: props.tutor.cidade || "",
            estado: props.tutor.estado || "PI",
            observacoes: props.tutor.observacoes || "",
        });
        ...
        const submit = () => {
            ...
            form.put(route('tutors.update', props.tutor.id), {
                onSuccess: () => {
